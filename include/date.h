...
/*									*/
/*   sys1 stores time as seconds past Jan 1, 1970 (UNIX format), with	*/
...
#define	ntim2xtim(x)  ((x)-2208988800U)	/* net-to-sys1 time		*/
#define	xtim2ntim(x)  ((x)+2208988800U)	/* sys1-to-net time		*/
