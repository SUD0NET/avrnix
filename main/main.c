...
void sh_help(void);
shellcmd sh_kill(int nargs, char *args[]);
...
const __flash uint8_t * const __flash cmdtab_help[] =
{
  ...
  (const __flash uint8_t[]) { ": tell how long the AVRnix system has been running" },
  (const __flash uint8_t[]) { ": reset the AVRnix system sw. THIS IS NOT a hw reset" },
  ...
  (const __flash uint8_t[]) { ": chimes a bell" }
};
...
//const struct	cmdent	cmdtab[] = {
//	{"memstat",	FALSE,	sh_memstat}, /* Make built-in */
//	{"editor",	FALSE,	sh_editor}, /* Make built-in */
//	{"basic",	FALSE,	sh_basic}, /* Make built-in */
//	{"help",	TRUE,	sh_help}, /* Make built-in */
//	{"echo",	FALSE,	sh_echo}
//	{"argecho",	TRUE,	sh_argecho},
//	{"cat",		FALSE,	sh_cat},
//	{"clear",	TRUE,	sh_clear},
//	{"date",	FALSE,	sh_date},
//	{"devdump",	FALSE,	sh_devdump},
//	{"echo",	FALSE,	sh_echo},
//	{"exit",	TRUE,	sh_exit},
//	{"help",	TRUE,	sh_help},
//	{"kill",	TRUE,	sh_kill},
//	{"memdump",	FALSE,	sh_memdump},
//	{"ps",		FALSE,	sh_ps},
//	{"sleep",	FALSE,	sh_sleep},
//	{"uptime",	FALSE,	sh_uptime},
//	{"?",		TRUE,	sh_help},
//	{"bell", 	FALSE,	sh_bell}
//};
