...
/************************************************************************/
/* Table of AVRnix shell commands and the function associated with each	*/
/************************************************************************/
...
const __flash uint8_t * const __flash cmdtab_cname[] =
{
  ...
  (const __flash uint8_t[]) { "wr" },
  (const __flash uint8_t[]) { "rd" }
};
...
const __flash uint8_t * const __flash cmdtab_help[] =
{
  ...
  (const __flash uint8_t[]) { "<addr> <reg> <byte> [byte...] : write to i2c device" },
  (const __flash uint8_t[]) { "<addr> <reg> <count> : read from i2c device" }
};
