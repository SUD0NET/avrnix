	...
	)
{
	...
	/* Check to see if directory contains a sys1 file system */

	if (lfscheck(&dir) == SYSERR) {
		panic("directory does not contain a sys1 file system");
	}
	kprintf("Directory corresponds to a local sys1 file system\n");
